 ...
 * Generated at: 2017-05-03 09:05:52 UTC
...
import org.wso2.carbon.statistics.ui.Utils;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /statistics/index.jsp(23,0) name = basename type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_fmt_005fbundle_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            try {
              ...
              // /statistics/index.jsp(24,0) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_carbon_005fbreadcrumb_005f0.setLabel("system.statistics");
              // /statistics/index.jsp(24,0) name = resourceBundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_carbon_005fbreadcrumb_005f0.setResourceBundle("org.wso2.carbon.statistics.ui.i18n.Resources");
              // /statistics/index.jsp(24,0) name = topPage type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_carbon_005fbreadcrumb_005f0.setTopPage(true);
              // /statistics/index.jsp(24,0) name = request type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            out.write("\n");
            out.write("\n");
            out.write("<script type=\"text/javascript\" src=\"js/statistics.js\"></script>\n");
            out.write("<script type=\"text/javascript\" src=\"js/graphs.js\"></script>\n");
            out.write("\n");
    ...
    boolean isSuperTenant = CarbonUIUtil.isSuperTenant(request);
            ...
            out.write("    var responseTimeGraphWidth = ");
            out.print( responseTimeGraphWidth);
            out.write(";\n");
            out.write("    var memoryGraphWidth = ");
            out.print( memoryGraphWidth );
            out.write(";\n");
            out.write("\n");
            out.write("    var responseTimeXScale = ");
            out.print( responseTimeGraphXScale );
            out.write(";\n");
            out.write("    var memoryXScale = ");
            out.print( memoryGraphXScale);
            out.write(";\n");
            out.write("\n");
            out.write("    initStats(responseTimeXScale, memoryXScale);\n");
            out.write("\n");
            ...
            out.write("    }\n");
            out.write("\n");
            out.write("    function drawMemoryGraph() {\n");
            out.write("        jQuery.plot(jQuery(\"#memoryGraph\"), [\n");
            out.write("            {\n");
            out.write("                label: \"");
            if (_jspx_meth_fmt_005fmessage_005f0(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\",\n");
            out.write("                data: graphUsedMemory.get(),\n");
            out.write("                lines: { show: true, fill: true }\n");
            out.write("            },\n");
            out.write("            {\n");
            out.write("                label: \"");
            if (_jspx_meth_fmt_005fmessage_005f1(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\",\n");
            out.write("                data: graphTotalMemory.get(),\n");
            out.write("                lines: { show: true, fill: true }\n");
            out.write("            }\n");
            out.write("        ], {\n");
            out.write("            xaxis: {\n");
            out.write("                ticks: graphUsedMemory.tick(),\n");
            out.write("                min: 0\n");
            out.write("            },\n");
            out.write("            yaxis: {\n");
            out.write("                ticks: 10,\n");
            ...
            out.write("        drawMemoryGraph();\n");
            out.write("    }\n");
            out.write("\n");
            out.write("    function checkMinValues() {\n");
            out.write("        var statRefreshInterval = document.statsConfigForm.statRefreshInterval.value;\n");
            out.write("        if (statRefreshInterval < 500) {\n");
            out.write("            document.statsConfigForm.statRefreshInterval.value = 500;\n");
            out.write("        }\n");
            out.write("        var respTimeGraphXScale = document.statsConfigForm.responseTimeGraphXScale.value;\n");
            out.write("        if (respTimeGraphXScale < 10) {\n");
            out.write("            document.statsConfigForm.responseTimeGraphXScale.value = 10;\n");
            out.write("        }\n");
            out.write("        var memoryGraphXScale = document.statsConfigForm.memoryGraphXScale.value;\n");
            out.write("        if (memoryGraphXScale < 10) {\n");
            out.write("            document.statsConfigForm.memoryGraphXScale.value = 10;\n");
            out.write("        }\n");
            out.write("        var responseTimeGraphWidth = document.statsConfigForm.responseTimeGraphWidth.value;\n");
            out.write("        if (responseTimeGraphWidth < 250) {\n");
            out.write("            document.statsConfigForm.responseTimeGraphWidth.value = 250;\n");
            out.write("        }\n");
            out.write("        var memoryGraphWidth = document.statsConfigForm.memoryGraphWidth.value;\n");
            out.write("        if (memoryGraphWidth < 250) {\n");
            out.write("            document.statsConfigForm.memoryGraphWidth.value = 250;\n");
            out.write("        }\n");
            out.write("    }\n");
            out.write("\n");
            out.write("    function restoreDefaultValues() {\n");
            ...
            if (_jspx_meth_fmt_005fmessage_005f2(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\", function() {\n");
            out.write("            document.statsConfigForm.statRefreshInterval.value = 6000;\n");
            out.write("            document.statsConfigForm.responseTimeGraphXScale.value = 50;\n");
            out.write("            document.statsConfigForm.memoryGraphXScale.value = 50;\n");
            out.write("            document.statsConfigForm.responseTimeGraphWidth.value = 500;\n");
            out.write("            document.statsConfigForm.memoryGraphWidth.value = 500;\n");
            out.write("            document.statsConfigForm.submit();\n");
            out.write("        });\n");
            out.write("    }\n");
            out.write("</script>\n");
            out.write("\n");
            ...
            out.write("                var url = \"system_stats_ajaxprocessor.jsp\";\n");
            ...
            out.write("                refresh = setInterval(\"refreshStats()\", ");
            out.print( statRefreshInterval );
            out.write(");\n");
            out.write("            });\n");
            out.write("        </script>\n");
            out.write("\n");
            out.write("        <p>&nbsp;</p>\n");
            out.write("\n");
            out.write("        <form action=\"index.jsp\" method=\"post\" name=\"statsConfigForm\">\n");
            ...
            out.print( statRefreshInterval);
            out.write("\"\n");
            out.write("                               name=\"statRefreshInterval\"\n");
            ...
            out.write("\n");
            out.write("                <tr>\n");
            out.write("                    <td colspan=\"2\" width=\"50%\"><strong>");
            ...
            out.print( responseTimeGraphXScale);
            out.write("\"\n");
            out.write("                               name=\"responseTimeGraphXScale\"\n");
            ...
            out.print( memoryGraphXScale);
            out.write("\"\n");
            out.write("                               name=\"memoryGraphXScale\"\n");
            out.write("                               maxlength=\"4\"/>\n");
            out.write("                    </td>\n");
            out.write("\n");
            out.write("                    ");
            ...
            out.print( responseTimeGraphWidth);
            out.write("\"\n");
            out.write("                               name=\"responseTimeGraphWidth\"\n");
            out.write("                               maxlength=\"4\"/>\n");
            out.write("                    </td>\n");
            out.write("                    ");
            ...
            out.print( memoryGraphWidth);
            out.write("\"\n");
            out.write("                               name=\"memoryGraphWidth\"\n");
            out.write("                               maxlength=\"4\"/>\n");
            out.write("                    </td>\n");
            out.write("                    ");
            ...
            out.write("                </tr>\n");
            out.write("                <tr>\n");
            out.write("                    <td colspan=\"4\" class=\"buttonRow\">\n");
            ...
            if (_jspx_meth_fmt_005fmessage_005f12(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\"\n");
            out.write("                               id=\"updateStats\" onclick=\"checkMinValues();document.statsConfigForm.submit()\"/>&nbsp;&nbsp;\n");
            ...
            if (_jspx_meth_fmt_005fmessage_005f14(_jspx_th_fmt_005fbundle_005f0, _jspx_page_context))
              return;
            out.write("\"\n");
            out.write("                               id=\"restoreDefaults\" onclick=\"restoreDefaultValues()\"/>&nbsp;&nbsp;\n");
            out.write("                    </td>\n");
            out.write("                </tr>\n");
            out.write("            </table>\n");
            out.write("        </form>\n");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(85,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f0.setKey("used");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(90,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f1.setKey("allocated");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(135,39) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f2.setKey("restore.defaults.prompt");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(147,8) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f3.setKey("system.statistics");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(180,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f4.setKey("statistics.configuration");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(184,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f5.setKey("statistics.refresh.interval");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(196,56) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f6.setKey("response.time.graph");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(201,56) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f7.setKey("memory.graph");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(208,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f8.setKey("x.scale");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(219,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f9.setKey("x.scale");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(234,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f10.setKey("x.width");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(245,24) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f11.setKey("x.width");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(263,67) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f12.setKey("update");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(265,66) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f13.setKey("reset");
  ...
  private boolean _jspx_meth_fmt_005fmessage_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_005fbundle_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /statistics/index.jsp(266,67) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fmessage_005f14.setKey("restore.defaults");
